...
composer create-project --repository-url=https://repo.magento.com/ magento/project-community-edition $FOLDER_NAME
...
find . -type f -exec chmod 755 {} \;                        # 644 permission for files
